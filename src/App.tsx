...
function App() {
  ...
  // ==========================================================================
  // TELA 1: LOGIN (ESTILIZADA)
  // ==========================================================================
  if (!clientId) {
      return (
          <div className="min-h-screen bg-[#0A0A0B] text-white font-sans flex flex-col items-center justify-center p-4 selection:bg-purple-500/30">
              ...
              <div className="w-full max-w-md bg-[#18181B] border border-white/5 p-8 rounded-3xl shadow-2xl text-center">
                  <div className="mx-auto w-16 h-16 bg-purple-500/10 rounded-2xl flex items-center justify-center mb-6">
                    <Bot className="w-8 h-8 text-purple-400" />
                  </div>
                  
                  <h1 className="text-3xl font-bold mb-2">ZapAgendador</h1>
                  <p className="text-slate-400 mb-8">Automação inteligente para sua agenda.</p>
                  
                  <button 
                    onClick={loginComGoogle} 
                    className="w-full bg-white text-black font-bold py-4 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-100 transition-all transform hover:scale-[1.02] shadow-lg shadow-purple-500/10"
                  >
    ...
    <div className="min-h-screen bg-[#0A0A0B] text-white font-sans flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-[#18181B] border border-white/5 rounded-3xl p-8 shadow-2xl relative overflow-hidden mt-10">
        ...
        <div className="text-center mb-8 border-b border-white/5 pb-6">
            <p className="text-xs text-slate-500 uppercase tracking-widest font-bold mb-1">Usuário Logado</p>
        ...
        <div className="flex flex-col items-center justify-center min-h-[300px]">
            ...
            {status.includes('✅') ? (
                 <div className="animate-in fade-in zoom-in duration-500 flex flex-col items-center text-center">
                     ...
                     <p className="text-slate-400 mb-6 max-w-[250px]">O robô está conectado ao WhatsApp e pronto para agendar.</p>
                ...
                <div className="flex flex-col items-center text-center w-full">
                    ...
                    {qrCode ? (
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 w-full flex flex-col items-center">
                            ...
                            <div className="flex items-center gap-2 text-slate-400 text-sm bg-white/5 px-4 py-2 rounded-full">
